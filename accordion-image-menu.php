...
$d_aim_options = array(
						...
						'open' => 200,
						'closed' => 100,
						'fix_dim' => get_option('medium_size_w'),						
						'dur' => 300,						
						'border' => 2,
						'open_type' => 'open_num',
						'element_open' => 0
	...
	function a_image_menu_widget() {
				...
				$options = get_option('a_i_m');
				 ...
				 echo $before_widget; 
              		...
              		echo $before_title."<h2 class='widgettitle'>".$options['im_title']."</h2>". $after_title;
				 ...
				 if (is_numeric($order) and ($order != 0)) {
						...
						$my_query = get_posts(array('cat'=>$m_cat,'numberposts'=>1));							
							...
							foreach ($my_query  as $post) {	
								...
								$the_image = a_m_image_url($post -> ID);								
								foreach((get_the_category($post -> ID)) as $category) $the_title = $category->cat_name;
...
if  ((empty($options)) ||  (empty($options['position']))) $options = $d_aim_options;
	...
	if(isset($_POST['Submit'])){
		...
		//dimensions
		$newoptions['fix_dim'] = $_POST['fix_dim'];
...
<h2>Accordion Image Menu Default Settings</h2>
...
<table width="100%" cellpadding="10" class="form-table">
  ...
  <tr valign="top">
  	<td width="200" align="right">
  	  <input name="fix_dim" id="fix_dim" value="<?php echo $fix_dim ?>" size="2"/> 
  	  px
  	</td>
...
<table width="100%" cellpadding="10" class="form-table">
  ...
  <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td align="left" scope="row">In the position <input name="element_open" type="text" value="<?php if ( empty($element_open)) echo 0; else echo $open_number ?>" size="2"/></td>
    </tr>
    <tr valign="top">
        <td width="200" align="left" colspan="2">
...
<h3>Shortcode Options</h3>
 <p>The accordion image menu allows some options in case that you don't want to use the default ones.</p>
<table width="100%" cellpadding="10" class="form-table">
   
  <tr valign="top">
    <td width="160" align="right"><strong>position</strong></td>
    <td width="998" align="left" scope="row">vertical / horizontal</td>
  </tr>
  <tr valign="top">
    <td width="160" align="right"><strong>cat</strong></td>
    <td align="left" scope="row">categories: Display post under categories separated by comma.</td>
  </tr>
  <tr valign="top">
    <td width="160" align="right"><strong>number</strong></td>
    <td align="left" scope="row">Number of items.</td>
  </tr>
  <tr valign="top">
    <td width="160" align="right"><strong>effect</strong></td>
    <td align="left" scope="row">Effect<strong>.</strong></td>
  </tr>
  <tr valign="top">
    <td width="160" align="right"><strong>duration</strong></td>
    <td align="left" scope="row">Time of transition closed-opened<strong>.</strong></td>
  </tr>       
  <tr valign="top">
    <td width="160" align="right"><strong>close-d</strong></td>
    <td align="left" scope="row">Dimension of the images when the menu is inactive.<strong></strong></td>
  </tr>
  <tr valign="top">
    <td width="160" align="right"><strong>open-d</strong></td>
    <td align="left" scope="row">Dimension of the images when the mouse is over them.<strong></strong></td>
  </tr> 
</table>
