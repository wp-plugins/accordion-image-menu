<?php
/*
Plugin Name: Custom Accordion Image Menu 
   ...
   //position
	...
	if(isset($the_items)) {
		...
		if ($position == 'horizontal') {
			...
			$a_height = $fixed_d;
			$a_width = $closed_d;
			$border_style = "border-right:".$border."px solid #333333;";			
        ...
        // vertical		
			...
			$a_height = $closed_d;
			$a_width = $fixed_d;
			$border_style = "border-bottom:".$border."px solid #333333;";
		...
		$image_menu .= "<div id='".$image_menu_div."' style='height:".$div_height."px; width:".$div_width."px;' class='imageMenu' >\n";		
			...
			foreach ($the_items as $the_item){
			  ...
			  $image_menu .= "<span class='vai_title ";
